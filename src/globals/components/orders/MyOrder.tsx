  ...
  const filteredData = myOrders
    ...
    .filter(
      (order) =>
        ...
        order.Payment.paymentMethod.includes(searchitem) ||
        order.Payment.paymentStatus.includes(searchitem) ||
        order.totalAmount.toString().includes(searchitem)
    )
    .filter(
      (order) =>
